...
function initAuditionPosting(auditionObj, auditionData) {
	if(auditionData.uninterested) {
		var auditionManager = '<div class="audition-manager uninterested clickable toggleable ' + auditionData.key + '"><span class="sixteen">&#10006;</span> - '+ auditionData.dateUninterested + ' - ' + auditionData.showName +' </div>';
		$(auditionObj).addClass('hide');

	} else if(auditionData.applied) {
		var auditionManager = '<div class="audition-manager applied clickable toggleable ' + auditionData.key + '"><span class="sixteen">&#10004;</span> - '+ auditionData.dateApplied + ' - ' + auditionData.showName +' </div>';
		$(auditionObj).addClass('hide');
